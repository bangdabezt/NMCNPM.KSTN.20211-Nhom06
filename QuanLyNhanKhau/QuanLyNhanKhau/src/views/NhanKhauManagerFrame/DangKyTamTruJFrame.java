...
public class DangKyTamTruJFrame extends javax.swing.JFrame {
    ...
    private boolean checkCMT(String cmt) {
        if (cmt.trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập số CCCD!", "Warning", JOptionPane.WARNING_MESSAGE);
            return false;
        } else {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Vui lòng nhập đúng định dạng CCCD!", "Warning", JOptionPane.WARNING_MESSAGE);
            }
        }
        return true;
    }
    ...
    private void checkBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkBtnActionPerformed
        if (checkCMT(soCmtJtf.getText())) {
            ...
            if (idNhanKhau > 0) {
                ...
                if (JOptionPane.showConfirmDialog(null, "Không tìm thấy người có số CCCD: " + soCmtJtf.getText() + ". Thêm mới?", "Confirm", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
