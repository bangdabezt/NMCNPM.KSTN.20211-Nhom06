...
import controllers.NhanKhauManagerController.UpdateController;
...
//    }
    ...
    public PeopleChangeJFrame(NhanKhauManagerPanelController parentController, JFrame parentJFrame, NhanKhauBean nkb) {
        this.parentController = parentController;
        this.parentFrame = parentJFrame;
        this.parentFrame.setEnabled(false);
        this.nhanKhauBean = nkb;
        initComponents();
        setInfo();
     ...
     */
    public PeopleChangeJFrame(JFrame parentJFrame, NhanKhauBean nkb) {
    ...
    private void setInfo() {
        ...
        bietDanhTxb.setText(temp.getBietDanh());
        hoTenTxb.setText(temp.getHoTen());
        namSinhDateC.setDate(temp.getNamSinh());
        gioiTinhCbb.setSelectedItem(temp.getGioiTinh());
        nguyenQuanTxb.setText(temp.getNguyenQuan());
        tonGiaoTxb.setText(temp.getTonGiao());
        danTocTxb.setText(temp.getDanToc());
        quocTichTxb.setText(temp.getQuocTich());
        soCMTTxb.setText(cmt.getSoCMT());
        soHoChieuTxb.setText(temp.getSoHoChieu());
        noiThuongTruTxb.setText(temp.getNoiThuongTru());
        diaChiHienNayTxb.setText(temp.getDiaChiHienNay());
        trinhDoHocVanTxb.setText(temp.getTrinhDoHocVan());
        trinhDoChuyenMonTxb.setText(temp.getTrinhDoChuyenMon());
        trinhDoNgoaiNguTxb.setText(temp.getTrinhDoNgoaiNgu());
        bietTiengDanTocTxb.setText(temp.getBietTiengDanToc());
        ngheNghiepTxb.setText(temp.getNgheNghiep());
        noiLamViecTxb.setText(temp.getNoiLamViec());
    }
    ...
    private void CreateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateBtnActionPerformed
        if (validateValueInForm()) {
            ...
            try {
                if (this.controller.updatePeople(this.nhanKhauBean)) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        TieuSuChangeJFrame tieuSuChangeJFrame = new TieuSuChangeJFrame(this, this.nhanKhauBean);
        tieuSuChangeJFrame.setLocationRelativeTo(null);
        tieuSuChangeJFrame.setResizable(false);
        tieuSuChangeJFrame.setVisible(true);
