...
public class DangKyTamVangJFrame extends javax.swing.JFrame {
    ...
    private void checkCMT() {
        ...
        if (tempCMT.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Vui lòng nhập số CCCD!", "Warning!!", JOptionPane.WARNING_MESSAGE);
            return;
        } else {
            try {
                long cmt = Long.parseLong(tempCMT);
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Vui lòng nhập đúng định dạng CCCD!", "Warning!!", JOptionPane.WARNING_MESSAGE);
                return;
            }
        }
