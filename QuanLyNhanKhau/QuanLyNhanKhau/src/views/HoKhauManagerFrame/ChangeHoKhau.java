...
public class ChangeHoKhau extends javax.swing.JFrame {
    ...
    private final HoKhauBean hoKhauBean;
     ...
     * @param parentJFrame
     */
    public ChangeHoKhau(JFrame parentJFrame, HoKhauBean hkb, HoKhauPanelController parentController) {
        initComponents();
        ...
        setInfo();
        setDataThanhVien();
        setTitle("Sửa thông tin hộ khẩu");
    }
    ...
    public void setDataChuHo() {
        ...
        this.soCMTChuHo.setText(NhanKhauService.getCMT(this.chuHo.getNhanKhauModel().getID()));
    }
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Số CCCD chủ hộ:");
    ...
    private void selectBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectBtnActionPerformed
        UpdateChoosePeople updatechoosePeople = new UpdateChoosePeople(this.chuHo, this);
        updatechoosePeople.setLocationRelativeTo(null);
        updatechoosePeople.setResizable(false);
        updatechoosePeople.setVisible(true);
    ...
    private void setInfo() {
    	...
    	chuHo.setNhanKhauModel(hoKhauBean.getChuHo());
    	setDataChuHo();

    	this.hoKhauBean.getListThanhVienCuaHo().forEach(person -> {
    		MemOfFamily temp = new MemOfFamily();
    		temp.setThanhVienCuaHoModel(person);
    		temp.setNhanKhau(NhanKhauService.getNhanKhauByID(person.getIdNhanKhau()));
    		this.list.add(temp);
    	});
    	setDataThanhVien();
    }
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        if (this.maHoKhauJtf.getText().trim().isEmpty() 
            ...
            hoKhauBean.getListThanhVienCuaHo().clear();
            ...
            try {
                ...
                this.parentJFrame.setEnabled(true);
                this.parentController.refreshData();
                dispose();
            } catch (Exception e) {
