/*
 * lá»›p xá»­ lÃ½ sá»± kiá»‡n chuyá»ƒn qua láº¡i giá»¯a cÃ¡c mÃ n hÃ¬nh táº¡i mainFrame
 * táº¡o ra cÃ¡c hiá»‡u á»©ng lá»±a chá»�n cÃ¡c label
 */
package controllers;
    ...
    public void setView(JPanel jpnItem, JLabel jlbItem, String kind) {
        ...
        switch(kind) {
                ...
                case "ThongKe":
                    ...
                    break;
                case "PhanThuong":
                	view = new PhanThuongPanel(this.jfrMain);
                	break;
                //any more
                default:
                    break;
